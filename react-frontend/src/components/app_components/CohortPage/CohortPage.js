  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          course: urlParams.singleCoursesId,
          $populate: [
            {
              path: "createdBy",
              service: "users",
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Cohort",
          type: "error",
          message: error.message || "Failed get Cohort",
        });
      });
