const { Cohort } = require("./cohort.class");
const createModel = require("../../models/cohort.model");
const hooks = require("./cohort.hooks");
...
module.exports = function (app) {
  ...
  app.use("/cohort", new Cohort(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("cohort");

  // Get the schema of the collections 
  app.get("/cohortSchema", function (request, response) {
