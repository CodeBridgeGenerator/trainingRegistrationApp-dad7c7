    ...
    module.exports = function (app) {
        ...
        const schema = new Schema(
          {
            category: { type: Schema.Types.ObjectId, ref: "courseCategory", comment: "Category, dropdown, false, true, true, true, true, true, true, courseCategory, courseCategory, one-to-one, name," },
