...
import seederData from "./courseCategories.seeder.json";
...
const CourseCategoriesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CourseCategoriesSeederDialogComponent);
