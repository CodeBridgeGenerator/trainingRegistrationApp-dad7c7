...
const CourseRegistrationPage = (props) => {
  ...
  useEffect(() => {
    ...
    client
      ...
      .find({
        query: {
          $limit: 10000,
          cohort: urlParams.singleCohortId,
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Registration",
          type: "error",
          message: error.message || "Failed get Registration",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("courseRegistration").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
        ...
        <div className="col-6 flex justify-content-end">
          <>
            ...
            <Button
              ...
              role="courseRegistration-add-button"
            />
          </>
        </div>
      </div>
