...
import seederData from "./cohort.seeder.json";
...
const CohortSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CohortSeederDialogComponent);
