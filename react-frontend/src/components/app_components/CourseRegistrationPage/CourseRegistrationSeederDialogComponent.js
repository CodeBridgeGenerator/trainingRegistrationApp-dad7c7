...
import seederData from "./courseRegistration.seeder.json";
...
const CourseRegistrationSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CourseRegistrationSeederDialogComponent);
