const { CourseCategories } = require("./courseCategories.class");
const createModel = require("../../models/courseCategories.model");
const hooks = require("./courseCategories.hooks");
...
module.exports = function (app) {
  ...
  app.use("/courseCategories", new CourseCategories(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("courseCategories");

  // Get the schema of the collections 
  app.get("/courseCategoriesSchema", function (request, response) {
