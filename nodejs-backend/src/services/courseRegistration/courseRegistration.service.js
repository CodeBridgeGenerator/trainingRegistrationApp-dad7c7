const { CourseRegistration } = require("./courseRegistration.class");
const createModel = require("../../models/courseRegistration.model");
const hooks = require("./courseRegistration.hooks");
...
module.exports = function (app) {
  ...
  app.use("/courseRegistration", new CourseRegistration(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("courseRegistration");

  // Get the schema of the collections
  app.get("/courseRegistrationSchema", function (request, response) {
